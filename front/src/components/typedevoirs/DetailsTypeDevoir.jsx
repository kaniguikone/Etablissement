...
const DetailsTypeDevoir = () => {
    ...
    useEffect(() => {
        api.get(`/typeDevoirs/${id}`)
            .then((res) => {
                setForm({
                    code_type_devoir: res.data.code_type_devoir || '',
                    description_type_devoir: res.data.description_type_devoir || '',
                });
            })
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        api.put(`/typeDevoirs/${id}`, form)
            .then(() => { toast.success('Modifications enregistrées.'); navigate('/TypeDevoirs'); })
            .catch((err) => {
        ...
        <section className="content content-wrapper">
            <div className="container bg-light mb-2 border">
                <div className="d-flex justify-content-between mb-2 border">
                    <h2 className="mt-2 container mb-1">Détails du type de devoir</h2>
                </div>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-end mb-3 gap-2">
                        <NavLink to="/TypeDevoirs" className="btn btn-secondary">Retour</NavLink>
...
export default DetailsTypeDevoir;
