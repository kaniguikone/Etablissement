...
> - **Lot 4 — Cas avancés** : à faire. Groupes pédagogiques (LV2 / dédoublements) + contrainte de parallélisme (D15), quinzaine semaine A/B (D16), séances 1h30, tandem PC/SVT contigu sans récré (D8), souples S3/S4/S6/S8/S10, phasage du solveur selon la procédure MENET. **Requis pour les lycées à options ; optionnel pour un collège simple.**
> - **Lot 5 — Multi-sites & finitions** : à faire. Grilles par bâtiment, déplacement inter-sites, warm-start depuis l'EDT archivé.
> - **Réorganisation du menu EDT** (menu dédié « Emploi du temps ») : à faire **après** le Lot 4 (pour ne réorganiser qu'une fois).
