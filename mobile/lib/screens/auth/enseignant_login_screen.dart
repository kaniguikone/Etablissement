...
class EnseignantLoginScreen extends StatefulWidget {
  const EnseignantLoginScreen({super.key});

  @override
  State<EnseignantLoginScreen> createState() => _EnseignantLoginScreenState();
}

class _EnseignantLoginScreenState extends State<EnseignantLoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    final err = await context.read<AuthProvider>()
        .loginEnseignant(_numeroCtrl.text.trim(), _passwordCtrl.text);
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          Text(
                            'Accédez à vos classes, devoirs et présences.',
                            style: TextStyle(
